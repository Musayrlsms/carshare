...
import React__default, { useState, useRef, createElement, useEffect } from 'react';
...
var SlideshowLightbox = function SlideshowLightbox(props) {
  ...
  var _useState5 = useState(props.magnifyingGlass ? props.magnifyingGlass : false),
    magnifyingGlassFeature = _useState5[0];
  var _useState6 = useState(props.disableImageZoom ? props.disableImageZoom : false),
  ...
  var _useState9 = useState(props.slideshowInterval ? props.slideshowInterval : 1100),
    slideshowInterval = _useState9[0];
  var _useState10 = useState(props.rightArrowStyle ? props.rightArrowStyle : {}),
    rightArrowStyle = _useState10[0];
  var _useState11 = useState(props.leftArrowStyle ? props.leftArrowStyle : {}),
    leftArrowStyle = _useState11[0];
  var _useState12 = useState(false),
    zoomedIn = _useState12[0],
    setZoomedIn = _useState12[1];
  var _useState13 = useState(props.roundedImages ? props.roundedImages : false),
  ...
  var _useState16 = useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState16[0],
    setDisplayFullScreenIcon = _useState16[1];
  var _useState17 = useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState17[0],
    setDisplayThumbnailIcon = _useState17[1];
  var _useState18 = useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState18[1];
  var _useState19 = useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState19[0],
    setDisplayMagnificationIcons = _useState19[1];
  var _useState20 = useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState20[0];
  var _useState21 = useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState21[0];
  var _useState22 = useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState22[0];
  var _useState23 = useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState23[0];
  var _useState24 = useState(props.rtl ? props.rtl : false),
    isRTL = _useState24[0];
  var _useState25 = useState(props.framework ? props.framework : ''),
    frameworkID = _useState25[0];
  var _useState26 = useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState26[0];
  var _useState27 = useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState27[0];
  var _useState28 = useState(props.licenseKey ? props.licenseKey : '');
  var _useState29 = useState(props.showLoader ? props.showLoader : false);
  var _useState30 = useState(props.showLoader ? props.showLoader : false),
  ...
  var _useState43 = useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState43[0],
    setBackgroundColor = _useState43[1];
  var _useState44 = useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState44[0];
  var _useState45 = useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState45[0],
    setTextColor = _useState45[1];
  var _useState46 = useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState46[0];
  var _useState47 = useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
    thumbnailBorder = _useState47[0];
  var _useState48 = useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState48[0],
    setShowThumbnails = _useState48[1];
  var _useState49 = useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState49[0];
  var _useState50 = useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    setImgAnimation = _useState50[1];
  var _useState51 = useState(props.arrowStyle ? props.arrowStyle : 'dark'),
  ...
  }), showControls && createElement("div", {
    className: "" + styles.controls
  }, disableZoom || displayMagnificationIcons == false ? null : createElement(motion.div, null, createElement(ZoomIn, {
    size: 24,
  ...
  })), disableZoom || displayMagnificationIcons == false ? null : createElement(motion.div, null, createElement(ZoomOut, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  })), displayDownloadBtn() ? createElement(Download, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  }) : null, displayFullScreenIcon ? isBrowserFullScreen ? createElement(motion.div, null, createElement(FullscreenExit, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  })) : createElement(motion.div, null, createElement(Fullscreen, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  })) : null, displayThumbnailIcon ? createElement(motion.div, null, createElement(GridFill, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  })) : null, shouldDisplayMagnifyingGlassIcon() ? createElement(motion.div, null, createElement(Search, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  }, isSlideshowPlaying ? createElement(PauseCircleFill, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  }, isImageCaption() && !zoomedIn ? createElement("div", {
